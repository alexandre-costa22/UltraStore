...
{
    public class PlatformsControllerBackup : Controller
    {
        private readonly UltraStoreContext _context;

        public PlatformsControllerBackup(UltraStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Manufacturer")] Models.Software platform)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Manufacturer")] Models.Software platform)
        {
            if (id != platform.Id)
            {
                return NotFound();
