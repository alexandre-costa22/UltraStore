...
namespace UltraStore.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Country,ComercialEmail,Address,FoundationDate")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Country,ComercialEmail,Address,FoundationDate")] Publisher publisher)
        {
            if (id != publisher.Id)
            {
                return NotFound();
