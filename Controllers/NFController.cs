...
namespace UltraStore.Controllers
{
    public class NFController : Controller
    {
        ...
        public NFController(UltraStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ClientId,Date,Amount,GameId")] Nota nf)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClientId,Date,Amount,GameId")] Nota nf)
        {
            if (id != nf.Id)
            {
                return NotFound();
